    ...
    <>
      <div className="restuarantCard">
        <div className="res-logo">
          <img src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/"+resCard.info.cloudinaryImageId} alt="res-logo" className="res-img" />
        </div>
        <h3>{resCard.info.name}</h3>
        <h4>{resCard.info.cuisines.join(",")}</h4>
        <h4>{resCard.info.avgRating} Star</h4>
